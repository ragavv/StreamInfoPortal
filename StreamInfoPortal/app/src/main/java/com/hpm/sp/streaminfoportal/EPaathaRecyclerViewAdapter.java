...
public class EPaathaRecyclerViewAdapter extends RecyclerView.Adapter<EPaathaRecyclerViewAdapter
        .DataObjectHolder> {
    ...
    public EPaathaRecyclerViewAdapter(Context context, ArrayList<Video> myDataset) {
    ...
    public DataObjectHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.epaatha_card_list, parent, false);
