...
public class BranchViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        articleList.add(new BranchDataObject("Bangalore Branches", " ", " "));
        ...
        articleList.add(new BranchDataObject("Mysore Branches", " ", " "));
